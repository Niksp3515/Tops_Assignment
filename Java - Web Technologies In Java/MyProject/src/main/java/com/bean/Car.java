...
public class Car {
	...
	private int cid,uid,car_mileage,car_capacity,car_luggage_cap,car_ppd;
	private String car_company,car_name,car_transmission,car_fuel,car_image;
	public int getCid() {
		return cid;
	}
	...
	public int getCar_luggage_cap() {
		return car_luggage_cap;
	}
	public void setCar_luggage_cap(int car_luggage_cap) {
		this.car_luggage_cap = car_luggage_cap;
	}
	...
	public int getCar_ppd() {
		return car_ppd;
	}
	public void setCar_ppd(int car_ppd) {
		this.car_ppd = car_ppd;
	}
